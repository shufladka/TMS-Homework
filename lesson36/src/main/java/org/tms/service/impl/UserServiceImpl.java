...
public class UserServiceImpl implements UserService {
    @Override
    public UserEntity create(String name, LocalDate dateOfBirth, Sex sex, UserType userType) {
    ...
    @Override
    public void update(UserEntity userEntity, String name, LocalDate dateOfBirth, Sex sex, UserType userType) {
